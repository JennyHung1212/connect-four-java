...
public class Connect4 {
    ...
    /**
     * The player with the highest consecutive discs wins.
     * @param board
     * @return A number representing the winner. Return -1 if no winner.
     */
    ...
    /**
     * Generate the board according to numOfPlayers and winningCriteria.
     * @return A m*n board
     */
